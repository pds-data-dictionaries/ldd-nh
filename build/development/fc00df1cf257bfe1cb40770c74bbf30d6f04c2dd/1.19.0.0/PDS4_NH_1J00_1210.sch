<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:nh  Version:1.2.1.0 - Fri Jun 05 20:51:07 UTC 2026 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="nh:MVIC_Calibration_Information">
      <sch:assert test="if (starts-with(//nh:MVIC_Details/nh:scan_type,'TDI')) then (nh:tdi_median_bias_level and not(nh:Framing_Biases)) else (not(nh:tdi_median_bias_level))">
        <title>nh:MVIC_Calibration_Information/Rule</title>
        In MVIC_Calibration_Information, time delay integration (TDI) scans data must include the attribute nh:tdi_median_bias_level and framing observations must not.
        TDI scans must not contain the nh:Framing_Biases class (framing observations generally should, but sometimes do not).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
