<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:nh  Version:1.1.0.0 - Mon Feb 05 18:19:24 UTC 2024 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="nh:Detector/nh:detector_type">
      <sch:assert test=". = ('CCD', 'Dust Imapct Counter', 'Electrostaic', 'Frame Transfer CCD', 'HgCdTe PICNIC array', 'Local oscillator vs. uplink signal phase comparator', 'SSD', 'Spectrograph')">
        <title>nh:Detector/nh:detector_type/nh:detector_type</title>
        The attribute nh:Detector/nh:detector_type must be equal to one of the following values 'CCD', 'Dust Imapct Counter', 'Electrostaic', 'Frame Transfer CCD', 'HgCdTe PICNIC array', 'Local oscillator vs. uplink signal phase comparator', 'SSD', 'Spectrograph'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="nh:Mission_Parameters/nh:mission_phase_name">
      <sch:assert test=". = ('KEM1 Encounter', 'KEM2 Encounter')">
        <title>nh:Mission_Parameters/nh:mission_phase_name/nh:mission_phase_name</title>
        The attribute nh:Mission_Parameters/nh:mission_phase_name must be equal to one of the following values 'KEM1 Encounter', 'KEM2 Encounter'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
