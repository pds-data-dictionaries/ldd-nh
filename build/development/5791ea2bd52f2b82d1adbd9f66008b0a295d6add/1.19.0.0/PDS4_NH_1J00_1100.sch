<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:nh  Version:1.1.0.0 - Sun Feb 23 20:23:13 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="nh:Alice_Details/nh:door_position">
      <sch:assert test="if (not(@xsi:nil eq 'true') and (not(. = ('Closed', 'In Between', 'Open')))) then false() else true()">
        <title>nh:Alice_Details/nh:door_position/nh:door_position</title>
        The attribute nh:Alice_Details/nh:door_position must be nulled or equal to one of the following values 'Closed', 'In Between', 'Open'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
